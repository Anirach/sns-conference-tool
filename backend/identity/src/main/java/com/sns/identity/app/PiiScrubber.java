...
public final class PiiScrubber {
    ...
    // JWT-shaped: three base64url segments where the payload is at least 16 chars. Stops
    // short of matching Java class FQNs like
    // `com.sns.app.config.RateLimitFilter` which would otherwise be redacted as JWTs.
    private static final Pattern JWT = Pattern.compile(
        "\\b[A-Za-z0-9_-]{8,}\\.[A-Za-z0-9_-]{16,}\\.[A-Za-z0-9_-]{8,}\\b"
    );
