  ...
  return (
    <div>
      <header className="mb-8">
        ...
        <h2 className="mt-2 font-serif text-3xl">Overview</h2>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
          ...
          <StatCard label="Matches" value={isLoading ? "…" : data?.matches.total ?? 0} />
          <StatCard
      ...
      <section className="mt-10 grid gap-3 md:grid-cols-2">
        ...
        >
          ...
          <p className="mt-1 font-serif text-lg">Manage events &amp; QR codes →</p>
        </Link>
        <Link
          href="/admin/users"
          className="hairline rounded-md bg-surface px-5 py-4 transition-colors hover:bg-surface-muted"
